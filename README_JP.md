...
デプロイされたURLにアクセスしてください。インストールは不要です。

---

## ビルド・リリース

本プロジェクトは [Next.js](https://nextjs.org/) を使用し、[Cloudflare Pages](https://pages.cloudflare.com/) にデプロイしています。  
ソースからビルドする場合は、リポジトリをクローンし、[Next.js ドキュメント](https://nextjs.org/docs) の手順に従ってください。
