 ...
 * again.
 *
 * This is the only way back into a world that has stopped being public: the
 * launch URL is built from the ids alone and asks VRChat's API for nothing, so
 * it still works long after the world has left the API behind.
 */
